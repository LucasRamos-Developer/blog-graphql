...
export interface UserInstance extends Sequelize.Instance<UserAttributes>, UserAttributes {
  isPassword(encode_password: string, password: string) : boolean;
}
...
export default (sequelize: Sequelize.Sequelize, DataTypes: Sequelize.DataTypes) : UserModel => {
  ...
  User.prototype.isPassword = (encode_password: string, password: string) : boolean => {
    return compareSync(password, encode_password);
  }
